  ...
  return Scaffold(
    appBar: AppBar(
      title: StreamBuilder<DocumentSnapshot>(
          stream: FirebaseFirestore.instance
              ...
              .snapshots(),
          builder: (_, snap) {
            if (!snap.hasData) return const Text('Dashboard',style: TextStyle(color: Colors.white),);
    ...
    body: StreamBuilder<QuerySnapshot>(
      ...
      builder: (_, snap) {
        ...
        if (docs.isEmpty) {
          return  Center(
            child: Image.network(height: 300,"https://img.freepik.com/free-vector/no-data-concept-illustration_114360-616.jpg"));
        }
          ...
          itemBuilder: (_, i) {
            ...
            return Card(
              ...
              child: ListTile(
                ...
                subtitle: Text('Number of questions attempted: ${data['questionsAttempted']}'),
        ...
        children: [
          _buildFAB(
            ...
            onTap: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => ManageQuestionsPage(uid: uid)),
            ),
          ),
